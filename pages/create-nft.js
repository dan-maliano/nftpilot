...
const projectId = '2IHPWbNNYDpU4ymGzJ4QxQlh2bY';
const projectSecret = '68b08d3fa97e4010c591108c29951ce6';
...
const dedicateEndPoint = 'https://nftpilot.infura-ipfs.io/ipfs'
...
export default function CreateNftPage() {
    ...
    return (
        <>
            ...
            <div className='main page-wrap create-page'>
                    ...
                    <div className='relative flex flex-col mx-4 sm:mx-12 lg:mx-[9vw] space-y-6 text-white dark:text-gray-800'>
                        ...
                        <div className='create-page-wrap flex flex-col lg:flex-row items-center'>
                            ...
                            <div className='create-form-wrap relative w-full lg:w-[45%] flex-none flex flex-col space-y-4'>
                                {/* file chooser */}
                                <div className='create__title-wrap'>
                                ...
                                <div className='create__inputs-wrap'>
                                    ...
                                    <label className='dragdrop__label'>
                                    ...
                                    <div className='relative input-wrap'>
                                        ...
                                        <div className='my-input__icon-wrap'>
                                            <img src="/assets/svg/input-icon_item.svg" alt="Ethereum NFT" className='input-price__value'></img>
                                        </div>
                                    </div>
                                    ...
                                    <div className='relative input-wrap'>
                                        ...
                                        <div className='my-input__icon-wrap'>
                                            <img src="/assets/svg/input-icon_category.svg" alt="Ethereum NFT" className='input-price__value'></img>
                                        </div>
                                    </div>
                                    <div className='relative input-wrap'>
                                        ...
                                        ></input>
                                        <div className='my-input__icon-wrap'>
                                            <img src="/assets/svg/input-icon_asset.svg" alt="Ethereum NFT" className='input-price__value'></img>
                                        </div>
                                    </div>
                                    <div className='relative textarea-wrap'>
                                        ...
                                        <div className='my-input__icon-wrap'>
                                            <img src="/assets/svg/input-icon_descr.svg" alt="Ethereum NFT" className='input-price__value'></img>
                                        </div>
                                    </div>
                                    {isActive?                                <button className='my-button rounded-full bg-gradient-to-b from-[#3461FF] to-[#8454EB] text-white text-base px-6 sm:px-10 py-2 shadow-md m-auto' id="btn-create-nft" onClick={createMarketItem}><span>Create</span></button>
                                    :<button className='my-button' id="btn-create-nft" ><span>{buttonTitle}</span></button>}
                                </div>
                            </div>
                        </div>
                    </div>
