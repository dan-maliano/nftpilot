            ...
            <div className='relative w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto'>
                <div className='flex flex-col mx-4 sm:mx-16 lg:mx-[9vw] space-y-6'>
                    ...
                    <div className='flex flex-col space-y-6'>
                        ...
                        <div className='resell-purchased-wrap'>
                            <div className='resell-purchased__text'>
                              {!purchasedItems?  <p>You Purchased {purchasedItems.length} NFTS</p>: <p>Start To Purchased Items Now</p>}
                            </div>
                        </div>
