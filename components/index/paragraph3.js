...
export default function Paragraph3() {
    ...
    return (
        <div className='relative w-full h-auto'>
                <div className='benefits__wrap mx-4 mt-8 sm:mx-16 sm:mt-16 lg:mx-[9vw] lg:mt-[9vw]'>

                <div className='benefits__img-side'>
                    <img src='/assets/png/benefits-img-n.png'></img>
                </div>

                <div className='benefits__items-side'>
