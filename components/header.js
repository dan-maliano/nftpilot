            ...
            <div className='w-full 2xl:max-w-screen-2xl h-full mx-auto'>
                <div className="mx-auto px-4 sm:px-8 lg:px-[6vw] h-full">
                    <div className="relative flex items-center justify-between h-full">
                        <div className="hamburger-button absolute inset-y-0 left-0 flex items-center lg:hidden">
                            {/* Mobile menu button*/}
                            <Disclosure.Button className="hamburger-button-icon inline-flex items-center justify-center p-2">
                        ...
                        <div className="flex-1 flex items-center justify-between lg:items-stretch lg:justify-between h-full">
                            <div className="header__left-side">
                                ...
                                <div className='theme-switch-wrap relative grid place-items-center'>
                                    <Switch checked={themeMode} onChange={toggleThemeMode} className={classNames(themeMode ? '' : '', 'transition duration-150 ease-out relative inline-flex items-center h-6 w-12 theme-switch-button')}>
                                        <div className='absolute left-0 w-1/2 text-[#FFE951] theme-switch-icon'>
                                            <FontAwesomeIcon icon={faMoon} ></FontAwesomeIcon>
                                        </div>
                                        <span className={classNames(themeMode ? 'translate-x-6' : 'bg-white translate-x-0', 'inline-block w-6 h-6 transform rounded-full transition duration-300 theme-switch-slider')}
                                        />
                                    </Switch>
                                </div>
                            </div>
                            <div className="header__right-side lg:block lg:ml-70px h-full">
                                   ...
                                   {account? <Menu as="div" className="relative inline-block text-left">
                                        ...
                                        <Menu.Items className="user-dropdown absolute right-0 w-80 mt-4 origin-top-right shadow-lg">
                                            <div className='flex flex-col space-y-6'>
                                                <Link href="/account/myProfile">
                                                    ...
                                                    <Menu.Item>
                                                        <div className='user-dropdown__account flex flex-row space-x-3'>
                                                            <div className='user-dropdown__account-logo'>
                                                                <img src="/assets/svg/metamask-logo.svg"></img>
                                                            </div>
                                                ...
                                                <div className='user-dropdown__links-wrap'>
                                    ...
                                    <button className='my-button my-button_connect text-white shadow-lg' onClick={connectMetamask}><span>Connect Wallet</span></button>
}
                                </div>
                            </div>
                        </div>
                ...
                {/* Mobile menu button*/}
                    ...
                    <div className="hidden-nav__list flex flex-col just space-y-4">
                        {headers.map((item, index) => (
                            <Disclosure.Button
                            key={item.name}
                            as="a"
                        ...
                        <div className='theme-switch-wrap flex-1 relative grid px-3 py-2'>
                            <Switch checked={themeMode} onChange={toggleThemeMode} className={classNames(themeMode ? '' : '', 'transition duration-150 ease-out relative inline-flex items-center h-6 w-12 theme-switch-button')}>
                                ...
                                <span className={classNames(themeMode ? ' translate-x-6' : ' translate-x-0', 'inline-block w-6 h-6 transform rounded-full transition duration-300 theme-switch-slider')}
                                />
                            </Switch>
                        </div>
                        ...
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="hidden-nav__user-dropdown pt-4 pb-2 text-sm text-gray-500">
                                    <div className='flex flex-col space-y-6'>
                                        <Link href="/account/myProfile">
                                            <a>
                                                <div className='user-dropdown__account flex flex-row space-x-3'>
