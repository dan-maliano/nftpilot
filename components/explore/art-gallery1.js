                ...
                <div key={item.itemId} className="top-nft__item w-full grid grid-cols-1 justify-items-center gap-2 ">
                    ...
                    <Link href={{
                        ...
                        <div className="top-nft__img-wrap">
                            <img src={item.image} alt={item.name} className='w-1/2 lg:w-[45%] xl:w-[55%] '></img>
                        </div>
                    </Link>


                    <div className="top-nft__info">
                        ...
                        <Link href={{
                            ...
                            <button className='my-button'><span> {item.buttonTitle}</span></button>
                        </Link>
                    </div>
